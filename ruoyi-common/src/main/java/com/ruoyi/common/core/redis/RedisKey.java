...
import com.ruoyi.common.enums.AgentStatusEnum;
import com.ruoyi.common.enums.AgentUserStatusEnum;
...
public class RedisKey {
     ...
     * @return
     */
    public static String getClientUserKey(final String auth) {
        StringBuffer sb = new StringBuffer();
    ...
    public static String getSnsAccountKey(String name) {
        return "sns_account:" + name;
    }
    ...
    public static String getUserKey(String orgi) {
        StringBuffer sb = new StringBuffer();
        sb.append(orgi);
        sb.append(":users");
        return sb.toString();
    ...
    public static String getUserNameKey(String orgi) {
        StringBuffer sb = new StringBuffer();
        sb.append(orgi);
        sb.append(":username");
        return sb.toString();
     ...
     * @return
     */
    public static String getAgentDayCommKey(final String agentno) {
        StringBuffer sb = new StringBuffer();
        sb.append("DAY_COMM_");
        sb.append(DateUtils.dateTime(new Date()));
        sb.append(":");
        sb.append(agentno);
        return sb.toString();
    }
